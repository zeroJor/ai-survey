import type { AnswerRecord } from '@/types/talk';
...
/** Lisa while the micro-reply sentiment is loading (before API returns). */
export const MICRO_REPLY_LOADING_GESTURE_ID: AssistantGestureId = 'seria';
...
export function microReplyLoadingGesture(): AssistantGesture {
  return gestureById(MICRO_REPLY_LOADING_GESTURE_ID);
}
